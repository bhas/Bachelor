...
Backpropagation is the most common algorithm for supervised ANNs. It adjusts the weights from the end (the output neurons) back to the start (the input neurons).
