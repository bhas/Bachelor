...
In this chapter we try to develop a default strategy by implementing an ANN to observe actions from other players and learn their strategy. This solution did not work for us. 
