...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(ControlPanel controlPanel) {
        ...
        for (int i = 0; i < 5; i++) {
            cardLabels[i] = new JLabel(new ImageIcon(ResourceManager.getIcon("images/card_placeholder.png")));
            gc.gridx = i;
            gc.gridy = 2;
            gc.gridwidth = 1;
            gc.gridheight = 1;
    ...
    public void update(List<Card> cards, int bet, int pot) {
        ...
        for (int i = 0; i < NO_OF_CARDS; i++) {
            if (i < noOfCards) {
                cardLabels[i].setIcon(new ImageIcon(ResourceManager.getCardImage(cards.get(i))));
            } else {
                cardLabels[i].setIcon(new ImageIcon(ResourceManager.getIcon("images/card_placeholder.png")));
            }
        }
    }
