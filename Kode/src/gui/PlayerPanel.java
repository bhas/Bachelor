...
public class PlayerPanel extends JPanel {
    ...
    private static final BufferedImage BUTTON_PRESENT_ICON =
            ResourceManager.getIcon("images/button_present.png");
    
    /** Empty dealer button image when player is not dealer. */
    private static final BufferedImage BUTTON_ABSENT_ICON =
            ResourceManager.getIcon("images/button_absent.png");
    
    private static final BufferedImage CARD_PLACEHOLDER_ICON =
        ResourceManager.getIcon("images/card_placeholder.png");

    private static final BufferedImage CARD_BACK_ICON =
    ...
    public PlayerPanel() {
        ...
        card1Label = new JLabel(new ImageIcon(CARD_PLACEHOLDER_ICON));
        card2Label = new JLabel(new ImageIcon(CARD_PLACEHOLDER_ICON));
        dealerButton = new JLabel(new ImageIcon(BUTTON_ABSENT_ICON));
    ...
    public void update(Player player) {
        ...
        if (player.hasCards()) {
            ...
            if (cards.length == 2) {
                // Visible cards.
                card1Label.setIcon(new ImageIcon(ResourceManager.getCardImage(cards[0])));
                card2Label.setIcon(new ImageIcon(ResourceManager.getCardImage(cards[1])));
            } else {
                // Hidden cards (face-down).
                card1Label.setIcon(new ImageIcon(CARD_BACK_ICON));
                card2Label.setIcon(new ImageIcon(CARD_BACK_ICON));
            }
        } else {
            // No cards.
            card1Label.setIcon(new ImageIcon(CARD_PLACEHOLDER_ICON));
            card2Label.setIcon(new ImageIcon(CARD_PLACEHOLDER_ICON));
        }
    }
    ...
    public void setDealer(boolean isDealer) {
        if (isDealer) {
            dealerButton.setIcon(new ImageIcon(BUTTON_PRESENT_ICON));
        } else {
            dealerButton.setIcon(new ImageIcon(BUTTON_ABSENT_ICON));
        }
    }
